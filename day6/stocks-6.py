...
print(f"Max close price: {max(close_prices)}")
print(f"Min close price: {min(close_prices)}")

open_prices = [m["open"] for m in measurements]
print(f"Max open price: {max(open_prices)}")
print(f"Min open price: {min(open_prices)}")
