...
#
# They also can be used directly in the list oriented methods
#

print(f"Max close price: {max(m['close'] for m in measurements)}")
print(f"Min close price: {min(m['close'] for m in measurements)}")
print(f"Sorted close prices: {sorted(m['close'] for m in measurements)}")
