...
#
# Repeat to find the min closing price (ugh)
#
...
for line in data_str.split("\n"):
    ...
    if max_close_price is None or close_price > max_close_price:
        max_close_price = close_price

    if min_close_price is None or close_price < min_close_price:
