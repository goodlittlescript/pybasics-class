...
#
# any/all come up in conditionals
#

if any(m["close"] > 5000 for m in measurements):
    print("found a close price greater than 5000")
else:
    print("did not find a close price greater than 5000")

if all(m["close"] < 5000 for m in measurements):
    print("all close prices were less than 5000")
else:
    print("not all close prices were less than 5000")
